# Functional Python [![](https://github.com/meghnapamula/functional-python/workflows/tests/badge.svg)](https://github.com/meghnapamula/functional-python/actions?query=workflow%3Atests)
